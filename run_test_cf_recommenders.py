...
def run_recommender(recommender_class):
    ...
    try:
        ...
        ICM_all = None#dataSplitter.get_loaded_ICM_dict()["ICM_genres"]
        UCM_all = None#dataSplitter.get_loaded_UCM_dict()["UCM_all"]
        ...
        evaluator = EvaluatorHoldout(URM_test, [3,5,7,10], exclude_seen = True)
        ...
        evaluator = EvaluatorNegativeItemSample(URM_test, URM_train,[3,5,7,10], exclude_seen = True)
